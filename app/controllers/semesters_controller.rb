...
class SemestersController < ApplicationController
  ...
  # def set_current
  #   Semester.update_all(current: false) # set all semesters to false
  #   semester = Semester.find(params[:id])
  #   semester.update(current: true)
  #   redirect_to semesters_path, notice: "Current semester set to #{semester.name}."
  # end
